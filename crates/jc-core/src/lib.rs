...
pub use kinds::{
    ...
    GitOrigin, GitSource, KubernetesBinding, Layer, LayerFilter, LayerSpec, LayerStyle, Mapping,
    MappingSpec, MappingTest, ModelProvider, NativeBlock, NativeLanguage, Operation,
    ...
    Quotas, RateLimits, RegistrationInfo, RemoteSource, Representation, Role, RoleBinding,
    RoleBindingSpec, RoleScope, RoleSpec, Schedule, ScopeDefinition, ScopeDefinitionSpec, SemVer,
